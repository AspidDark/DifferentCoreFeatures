...
public class CityController : ControllerBase
{
    ...
    public CityController(IConfiguration configuration, 
        IOptions<CityStatusOptions> options,
    ...
    public object Get()
    {
        ...
        return new
        {
            Config = new { name, population }, //Обновляется при обновлении источника
            ConfigOptions = new { _options.Name, _options.Population }, //НЕ!!! Обновляется при обновлении источника
            ConfigOptionsSnaphot = new { _optionsSnapshot.Name, _optionsSnapshot.Population }, //LifeTime Scoped
            ConfigOptionsMonitor = new { _optionsMonitor.Name, _optionsMonitor.Population } //LifeTime Singleton
        };
    }
}